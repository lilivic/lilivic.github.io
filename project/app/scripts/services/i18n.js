...
angular.module('lilivicApp').service('i18n', function () {
  ...
  var dictionary = {
    en: {
      ...
      landing_quotation: '"To me there is no past or future in art. If a work of art does not live in the present, it must not be considered at all"',
      landing_quotation_author: '(Pablo Picasso)',
      media: 'Media',
      media_blog: 'Blog',
    ...
    pt: {
      ...
      landing_quotation: '"Aliás, não há, na arte, nem passado nem futuro. A arte que não estiver no presente jamais será arte"',
      landing_quotation_author: '(Pablo Picasso)',
      media: 'Mídia',
      media_blog: 'Blog',
      media_clipping: 'Clipping',
